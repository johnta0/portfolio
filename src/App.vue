    ...
    <div id="footer">
      <div id="footer-text">
          <a href="https://github.com/spencerwooo/portfolio">
            <img src="https://raw.githubusercontent.com/spencerwooo/portfolio/master/public/copyright.png" alt="copyright" width="150px" height="auto"/>
          </a>
        <p>
        ...
        menuOptionsRight: [
          {
            type: 'button',
            text: '🌟 ME ON GITHUB',
            path: 'https://github.com/johnta0/portfolio',
            class: 'button-github'
          }
        ]
      }
